...
Переходы между клипами, несколько дорожек, отдельная работа со звуком, drag & drop файлов в окно, сохранение проекта, экспорт без перекодирования, экран настроек, смена языка без перезапуска, другие ОС.
